        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group" style="margin-bottom:1rem">
              ...
              <a href="administration.forum.vue.php" class="list-group-item active d-flex justify-content-between align-items-center" style="background-color:#8CB75B; border-color:#8CB75B;"> Forum <span class="badge badge-secondary">33</span></a>
