...
--
-- Hôte : localhost:8889
-- Généré le :  mar. 27 mars 2018 à 21:36
...
CREATE TABLE `tj_evaluation_eval` (
...
--
-- Index pour la table `tj_evaluation_eval`
--
ALTER TABLE `tj_evaluation_eval`
  ADD PRIMARY KEY (`mat_id`,`form_id`,`mem_id`),
  ADD KEY `fk_evaluation_form_id` (`form_id`),
  ADD KEY `fk_evaluation_mem_id` (`mem_id`);
...
--
ALTER TABLE `tj_evaluation_eval`
  ADD CONSTRAINT `fk_evaluation_form_id` FOREIGN KEY (`form_id`) REFERENCES `t_formation_form` (`form_id`),
  ADD CONSTRAINT `fk_evaluation_mat_id` FOREIGN KEY (`mat_id`) REFERENCES `t_matiere_mat` (`mat_id`),
  ADD CONSTRAINT `fk_evaluation_mem_id` FOREIGN KEY (`mem_id`) REFERENCES `t_membre_mem` (`mem_id`);
